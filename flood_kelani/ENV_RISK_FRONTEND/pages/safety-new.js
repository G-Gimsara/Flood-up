              ...
              <div className="bg-white rounded-xl shadow-lg p-6">
                ...
                <div className="space-y-6 mb-8">
                  ...
                  <div className="border-l-4 border-orange-500 bg-orange-50 rounded-lg p-6">
                    <h3 className="text-orange-600 font-bold text-lg mb-3">Alert - Stay Alert</h3>
                  ...
                  <div className="border-l-4 border-red-500 bg-red-50 rounded-lg p-6">
                    <h3 className="text-red-600 font-bold text-lg mb-3">Minor Flood - Take Action</h3>
                    <ul className="space-y-2">
                      <li className="flex items-start">
                  ...
                  <div className="border-l-4 border-red-800 bg-red-100 rounded-lg p-6">
                    <h3 className="text-red-800 font-bold text-lg mb-3">Major Flood - Evacuate Now</h3>
                    <ul className="space-y-2">
                      <li className="flex items-start">
